...
public class Board implements IRender {
	...
	protected InfoPanel _infopanel;
	...
	private int _live = Game.LIVE;
//	private double _speed = Game.bomberSpeed;
...
//	private int _bombRadius = Game.bombRadius;
	...
	public Board(Game game, Keyboard input, Screen screen) {
		...
		_input = input;
		_screen = screen;
		_sound = new Sound(Sound.BACKGROUND_MUSIC);
	...
	public void loadLevel(int level) {
		...
		try {
			...
			char[][] _map = ((FileLevelLoader) _levelLoader).getMap();
	...
	public boolean getBrickAt(double x, double y){
		if(_entities[(int)x + (int)y * _levelLoader.getWidth()] instanceof Brick)
			return true;
		return false;
	}
