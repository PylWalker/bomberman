...
public class Game extends Canvas {
	...
	private static final double BOMBERSPEED = 2.0;
	...
	protected static int live = LIVE;
	...
	public void start() {
		...
		while(_running) {
			...
			if(System.currentTimeMillis() - timer > 1000) {
				...
				_frame.setSpeed((double)(Math.round(Game.bomberSpeed*10))/10);
				_frame.setBomb(Game.bombRate);
				_frame.setFlame(Game.bombRadius);
				timer += 1000;
